...
<?php
/*
$CatalogBuyBtn - переменная для хранения модели товара, передаваемой с Каталога TV_7, 7_TRUCK, 6, 5, 4... и.т.д.
$CatalogBuy - переменная дублирующая передаваемую модель товара из каталога, которая в дальнейшем будет выведена в ReCallBack
*/

/*TV_7*/
/*TV_7_TRUCK*/	
	
	if($CatalogBuyBtn_V7204HT == "V 7204 H T") { $CatalogBuyBtn_V7204HT = ""; }	else { }
	...
	<div id="ReCall_form"> <!-- форма обратной связи -->					
		...
		<form method="post" action="" id="ajaxform_ReCall_form"> <br />
			<div id="ReCall_form_blocks">
				...
				<div id="ReCall_form_additional_text"><p> Нажимая на кнопку отправки формы, Я принимаю <span><a href = "pdf/document.pdf" target="_blank">«Соглашение об обработке персональных данных»</a></span> </p></div>
			</div>
		</form>		
	</div> <!-- ReCall_form -->
